#!/usr/bin/env bash
#
# Script to set up an Debian 12+ Server
...
sudo apt install -y -qq git-core gnupg flex bc bison build-essential zip curl zlib1g-dev gcc-multilib \
                        ...
                        libxml-simple-perl rsync nano ripgrep nload xmlstarlet binwalk tmate rclone htop python3.11-venv
sudo apt autoremove -y -qq
sudo apt purge snapd -y -qq
echo -e "\nDone."

echo -e "Installing and enabling docker... \n"
